import { z } from "zod";
import { juspayConfigEntryPublicSchema, juspayConfigEntryEncryptedSchema, juspayConfigEntrySchema, juspayFullyConfiguredEntrySchema, juspayUserVisibleConfigEntrySchema, juspayFormConfigEntrySchema } from "../juspay-app-configuration/config-entry";
import { hyperswitchConfigEntryEncryptedSchema, hyperswitchConfigEntryPublicSchema, hyperswitchConfigEntrySchema, hyperswitchFormConfigEntrySchema, hyperswitchFullyConfiguredEntrySchema, hyperswitchUserVisibleConfigEntrySchema } from "../hyperswitch-app-configuration/config-entry";
...
export const paymentAppConfigEntrySchema = z.object({
  ...
  export const paymentAppUserVisibleConfigEntrySchema = z.object({
  ...
  export const paymentAppFormConfigEntrySchema = z.object({
