import { Combobox, Text } from "@saleor/macaw-ui";
...
import { ChipHyperswitchOrange, ChipNeutral, ChipSuccess } from "@/modules/ui/atoms/Chip/Chip";
  ...
  return (
    <Tr>
      <Td className={tableStyles.td}>
        <Text sizes="medium" color={selectedConfigurationId ? "default2" : "defaultDisabled"}>
          {channel.name}
        </Text>
      </Td>
